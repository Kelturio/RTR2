...
#AutoIt3Wrapper_Res_Fileversion=1.0.0.91
...
#AutoIt3Wrapper_Run_Before=echo %fileversion% > akk.log
#AutoIt3Wrapper_Run_After=MOVE "%SCRIPTDIR%\%SCRIPTFILE%_tidy.txt" "%SCRIPTDIR%\tidy\%SCRIPTFILE%_tidy.txt"
#AutoIt3Wrapper_Run_After=MOVE "%SCRIPTDIR%\%SCRIPTFILE%_stripped.au3" "%SCRIPTDIR%\stripped\%SCRIPTFILE%_stripped.au3"
